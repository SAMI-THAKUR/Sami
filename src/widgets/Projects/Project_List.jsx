...
export default function Project_List() {
  return (
    <section
      id="SKILLS"
      className=" pl-10 sm:pl-20 lg:pl-32 pt-40 pb-44 dark:bg-darkbg bg-background pr-5"
    >
              ...
              <li className="">
                <button
                  ...
                  class={`text-[14px] sm:text-[18px]  font-robo w-fit inline-flex items-center justify-center px-10 py-2 border-b-2 dark:border-t-0   hover:text-gray-600  dark:hover:text-dhtext transition duration-300 ${
                    activeTab ===
                    project.id
                      ? "active dark:text-dhtext dark:border-dhtext"
                      : "text-[#404258] border-transparent"
                  }`}
                >
                  <Icon
                    icon={project.logo}
                ...
                {project.content.map(
                  (content) => (
                    <NavLink
                      ...
                      className="w-[290px] flex items-center gap-x-4 dark:bg-dhtext bg-htext border-[1px]  border-dhtext dark:border-htext hover:shadow-sm dark:hover:shadow-dhtext hover:shadow-htext p-4 py-2 transition duration-500 hover:-translate-y-1"
                    >
                      <img
                        src={
                          content.logo
                      ...
                      />
                      <div>
                        <h2 className="text-lg font-staat text-background dark:text-darkbg ">
                          {content.name}
                        </h2>
                        <div className="text-sm dark:text-[#404258] text-[#b5b5b5] font-robo">
                          {
