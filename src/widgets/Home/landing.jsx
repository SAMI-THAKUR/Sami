...
function Landing() {
  ...
  return (
    <section
      id="Home"
      className="pt-40 pb-28 flex flex-wrap justify-start pl-10 sm:pl-20 lg:pl-32 bg-background dark:bg-darkbg "
    >
      {/* ml-10 sm:ml-20 md:ml-36 lg:ml-44 */}
      <div
        id="text"
        className="w-max text-htext dark:text-dhtext flex flex-col justify-start"
      >
        <div className="text-[15px] sm:text-[18px] font-robo  flex justify-start text-[#6B728E] dark:text-[#6890b5]">
          Hi, I am
        </div>
        <div
          className="text-[50px] sm:text-[95px] font-staat font-semibold tracking-wide flex justify-start -mt-2"
          id="name"
        >
          SAMI THAKUR
        </div>
